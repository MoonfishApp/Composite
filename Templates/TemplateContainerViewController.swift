...
class TemplateContainerViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        templates = (children.first! as! ChooseTemplateViewController) // Set in storyboard
        options = (storyboard?.instantiateController(withIdentifier: NSStoryboard.SceneIdentifier("Options")) as! TemplateOptionsViewController)
        addChild(options)
